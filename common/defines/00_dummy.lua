...
NDefines.NAI.DEBASE_THRESHOLD = 10
NDefines.NAI.BUY_INDULGENCE_BASE_AI_DESIRE = -1						
NDefines.NAI.BUY_INDULGENCE_RIVAL_AI_DESIRE = -1						
NDefines.NAI.BUY_INDULGENCE_EXCOM_AI_DESIRE = -1
NDefines.NAI.DRILLING_BUDGET_OF_SURPLUS = 0.01
...
NDefines.NAIEconomy.BUDGETING_ADJUSTMENT_STEP = 0.1
NDefines.NAIEconomy.MILITARY_FOCUS_DEFAULT = 1.0
NDefines.NAIEconomy.ARMY_FRACTION_MILITARIST = 1.5
NDefines.NAIEconomy.FORT_FRACTION_MILITARIST = 0.1
NDefines.NAIEconomy.FORT_FRACTION_CAPITALIST = 0.1
